...
public class CellLayout extends ViewGroup {
	private final static String TAG = "------------CellLayout----------";
    ...
    static public int widthgap;
    static public int heigthtgap;
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        gridX=mLongAxisCells;
        gridY=mShortAxisCells;
...
//                return view;
    ...
    void onDropChild(View child, int cellX, int cellY) {
        ...
        LayoutParams lp = (LayoutParams) child.getLayoutParams();
        Log.i(TAG, cellXY[0]+"--7777777--"+cellXY[1]);
        lp.cellX = cellXY[0];
        lp.cellY = cellXY[1];
        lp.isDragging = false;
        mDragRect.setEmpty();
...
void onDropChild(View child, int lastcellX, int lastcellY,boolean isLast) {
